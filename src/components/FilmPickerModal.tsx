...
export function FilmPickerModal({
  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-3 sm:p-4 pt-[max(0.75rem,env(safe-area-inset-top,0px))] pb-[max(0.75rem,env(safe-area-inset-bottom,0px))] bg-black/80 backdrop-blur-sm animate-in fade-in">
